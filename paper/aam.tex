...
\text{where } E \in \mathit{EvaluationContext} &::= [] \alt \sapp{E}{\mexpr} \alt \sapp{\mval}{E} \\
              ...
              \mval \in \Value &::= \slam{\mvar}{\mexpr}
\end{align*}
The context decomposition to find a redex (left hand side of $\stepto_\beta$), substitution and re-plugging this semantics provides does not reflect what an effective implementation looks like.
%
