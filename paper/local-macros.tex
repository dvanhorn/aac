...
\newcommand{\zcfa}{$0$CFA}
\newcommand{\kcfa}{$k$CFA}
...
\newcommand{\Relevant}{\mathit{Relevant}}
...
\newcommand{\wfC}{{\mathit{wf}_C}}

\newcommand{\passp}{\mathit{pass?}}
...
\newcommand{\compatible}[2]{#1\mathrel{\bowtie}#2}

\newcommand{\somestate}{\lozenge}
\newcommand{\nextstate}{\blacklozenge}
\newcommand{\someotherstate}{\square}
\newcommand{\nextotherstate}{\blacksquare}
...
\newcommand{\decOK}{{\mathcal O}{\mathcal K}?}
