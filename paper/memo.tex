...
Recall the \hyperref[lem:irrelevance]{context irrelevance lemma} that if we have seen the results of a computation before from a different context, we can reuse them.
%
